...
#            print(self.grid.get_cell(coor[0],coor[1]).poll_neighbors())
    ...
    def build_states(self):
        ...
        self.states = {
            'still': {
                'block': [(20,30),(20,31),(21,30),(21,31)],
                'loaf': [(20,30),(20,31),(21,29),(21,32),(22,30),(22,32),(23,31)],
                'boat': [(20,30),(20,31),(21,30),(21,32),(22,31)],
                'tub': [(20,30),(21,29),(21,31),(22,30)]
            },
            'osc': {
                ...
                'penta': [(19,27),(19,32),(20,25),(20,26),(20,28),(20,29),(20,30),(20,31),(20,33),(20,34),(21,27),(21,32)]
            },
            'ship': {
